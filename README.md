...
We encourage [issues](https://github.com/CircleCI-Public/cimg-openjdk/issues) and [pull requests](https://github.com/CircleCI-Public/cimg-openjdk/pulls) against this repository.
