...
docker buildx build --platform=linux/amd64,linux/arm64 --file 23.0/Dockerfile -t cimg/openjdk:23.0 -t cimg/openjdk:23.0 --push .
docker buildx build --platform=linux/amd64,linux/arm64 --file 23.0/node/Dockerfile -t cimg/openjdk:23.0-node -t cimg/openjdk:23.0-node --push .
docker buildx build --platform=linux/amd64 --file 23.0/browsers/Dockerfile -t cimg/openjdk:23.0-browsers -t cimg/openjdk:23.0-browsers --push .
