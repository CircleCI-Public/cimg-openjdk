...
docker build --file 12.0/Dockerfile -t cimg/openjdk:12.0.2  -t cimg/openjdk:12.0 .
docker build --file 12.0/node/Dockerfile -t cimg/openjdk:12.0.2-node  -t cimg/openjdk:12.0-node .
docker build --file 12.0/browsers/Dockerfile -t cimg/openjdk:12.0.2-browsers  -t cimg/openjdk:12.0-browsers .
...
docker build --file 13.0/browsers/Dockerfile -t cimg/openjdk:13.0.2-browsers  -t cimg/openjdk:13.0-browsers .
